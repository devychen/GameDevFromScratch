...
- 📖 On Java (8th)
- (Sometimes for faster learning): Runoob Java: https://www.runoob.com/java/java-basic-syntax.html (CN)
- (haven't use it yet) Java Full Stack Knowledge: https://pdai.tech/md/outline/x-outline.html (CN)
2. C++
...
- w3schools Python Tutorial, I use it as Pythonwiki: https://www.w3schools.com/python/default.asp
